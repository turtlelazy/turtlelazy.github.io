...
const WorkXP = () => {
    const sfSkills = ['pyspark', 'pandas', 'AWS', 'ETL', 'PyArrow'];
    ...
    return (
        <Section header="Work Experience">
            <SectionCard title="Data Analytics Engineer @State Farm" description="Automated data ETL with pandas to modularize and scale out training pipelines across business lines." date={"May 2025 - Present"}
                skills={sfSkills}
                logoURL={"/sf.png"}>

            </SectionCard>

            <SectionCard title="Fullstack Developer @ErBuddy" description="Developed React Native health app to help users and their caretakers manage medication, measurements, and health files, and utilize the ERBuddy Smart Pillbox " date={"June 2024 - August 2024"} 
            link={'https://myerbuddy.com/'} 
            skills={ERBuddySkills}
            logoURL={"/erbuddy.jpeg"}>
            ...
            <SectionCard title="Software Developer @Menotti Enterprise"
                ...
                date={"June 2022 - August 2024"} link={'https://menottienterprise.com/'} skills={MenottiSkills} logoURL={"/menotti.jpeg"}>
            </SectionCard>
